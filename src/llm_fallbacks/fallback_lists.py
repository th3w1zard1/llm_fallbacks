...
ONLINE_REASONING_CHAT_LLM_PRIORITY_ORDER: list[str] = [
    "o1",
    "o1-preview",
...
ONLINE_CHAT_LLM_PRIORITY_ORDER: list[str] = [
    "gemini-exp-1206",
    "chatgpt-4o-latest",
    "gemini-exp-1121",
    "gemini-2.0-flash-thinking-exp",
...
ONLINE_EMBEDDING_MODELS: list[str] = [
...
LOCAL_GPU_RICH_RERANKING_MODELS: list[str] = [
...
LOCAL_GPU_RICH_RETRIEVAL_MODELS: list[str] = [
    "nv-embed-v2",
    "bge-en-icl",
    "lens-d8000",
    "stella_en_1.5b_v5",
...
LOCAL_GPU_RICH_STS_MODELS: list[str] = [
...
LOCAL_GPU_RICH_SUMMARIZATION_MODELS: list[str] = [
...
# Edge Device Models
LOCAL_EDGE_DEVICE_RERANKING_MODELS: list[str] = [
    "stella-base-en-v2",
...
LOCAL_CONSUMER_EMBEDDING_MODELS: list[str] = [
    "cde-small-v2",
    "cde-small-v1",
    "gte-base-en-v1.5",
    "gist-embedding-v0",
...
LOCAL_EDGE_DEVICE_RETRIEVAL_MODELS: list[str] = [
    "medembed-small-v0.1",
    "noinstruct-small-embedding-v0",
...
LOCAL_EDGE_DEVICE_STS_MODELS: list[str] = [
    "gist-small-embedding-v0",
    "stella-base-en-v2",
    "noinstruct-small-embedding-v0",
    "gte-small",
...
LOCAL_EDGE_DEVICE_SUMMARIZATION_MODELS: list[str] = []

# Consumer Grade Models
LOCAL_CONSUMER_GRADE_RERANKING_MODELS: list[str] = [
...
LOCAL_CONSUMER_GRADE_RETRIEVAL_MODELS: list[str] = [
...
LOCAL_CONSUMER_GRADE_STS_MODELS: list[str] = [
    "b1ade-embed",
    "mxbai-embed-large-v1",
    "mug-b-1.6",
...
LOCAL_CONSUMER_GRADE_SUMMARIZATION_MODELS: list[str] = [
    "mxbai-embed-large-v1",
    "stella-base-en-v2",
    "arabic-labse-matryoshka",
    "mug-b-1.6",
...
LOCAL_EDGE_DEVICE_RERANKING_LLM_PRIORITY_ORDER: list[str] = [
    "stella-base-en-v2",
    "gist-small-embedding-v0",
    "all-minilm-l12-v2",
    "all-minilm-l6-v2",
...
LOCAL_CONSUMER_GRADE_RERANKING_LLM_PRIORITY_ORDER: list[str] = [
    "granite-embedding-125m-english",
    "stella_en_400m_v5",
    "mxbai-embed-large-v1",
    "gist-large-embedding-v0",
...
LOCAL_GPU_RICH_RERANKING_LLM_PRIORITY_ORDER: list[str] = [
    "gte-qwen2-7b-instruct",
    "stella_en_1.5b_v5",
    "gme-qwen2-vl-7b-instruct-q5_k_s-gguf",
    "gme-qwen2-vl-7b-instruct",
...
LOCAL_OFFICIAL_EDGE_DEVICE_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_EDGE_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_OFFICIAL_CONSUMER_GRADE_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_CONSUMER_GRADE_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_OFFICIAL_MID_RANGE_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_MID_RANGE_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_OFFICIAL_GPU_RICH_LLM_PRIORITY_ORDER: list[str] = [
...
LOCAL_GPU_RICH_LLM_PRIORITY_ORDER: list[str] = [
...
if __name__ == "__main__":
    ...
    model_cost: dict[str, float] = litellm.model_cost
    variables: list[str] = [var for var in globals().keys() if not var.startswith("__")]
    for var_name in variables:
        this_list: list[str] = globals()[var_name]
